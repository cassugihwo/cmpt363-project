import svgPaths from "./svg-7s4w6ahl0c";

function Frame10() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[11px] py-[2px] relative rounded-[14px] shrink-0 w-[71px]">
...
function Frame11() {
  return (
    <div className="bg-[#3a3a3a] content-stretch flex flex-col items-center justify-center px-[11px] py-[2px] relative rounded-[14px] shrink-0 w-[65px]">
...
function Frame14() {
  return (
    <div className="bg-[#8149ec] content-stretch flex flex-col items-center justify-center px-[14px] py-[4px] relative rounded-[6px] shrink-0 w-[70px]">
      <p className="font-['Noto_Sans:Medium',sans-serif] font-medium leading-[1.47] relative shrink-0 text-[15px] text-center text-white tracking-[-0.165px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Finish
      </p>
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-[#212121] relative size-full" data-name="4">
