import svgPaths from "./svg-x1svfdar48";

function Frame10() {
  return (
    <div className="bg-[#3a3a3a] content-stretch flex flex-col items-center justify-center px-[11px] py-[2px] relative rounded-[14px] shrink-0 w-[71px]">
      <p className="font-['Noto_Sans:Regular',sans-serif] font-normal leading-[1.47] relative shrink-0 text-[#e9e9e9] text-[14px] text-center tracking-[-0.154px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Rewrite
      </p>
    </div>
  );
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[11px] py-[2px] relative rounded-[14px] shrink-0 w-[65px]">
      <p className="font-['Noto_Sans:Regular',sans-serif] font-normal leading-[1.47] relative shrink-0 text-[#898989] text-[14px] text-center tracking-[-0.154px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Create
      </p>
    </div>
  );
...
function Frame28() {
  return (
    <div className="h-[22px] relative shrink-0 w-[492px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 492 22">
        <g id="Frame 51">
          <line id="Line 25" stroke="var(--stroke-0, #898989)" x2="492" y1="10.5" y2="10.5" />
        </g>
      </svg>
    </div>
  );
...
function Frame12() {
  return (
    <div className="bg-[#303030] content-stretch flex items-center justify-center px-[13px] py-[3px] relative rounded-[12px] shrink-0">
      <div className="overflow-clip relative shrink-0 size-[18px]" data-name="icon-tune-sliders">
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5 13.5">
            <path d={svgPaths.p1c434f60} fill="var(--fill-0, #E9E9E9)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame13() {
  return (
    <button className="content-stretch cursor-pointer flex items-center justify-center px-[13px] py-[3px] relative rounded-[12px] shrink-0">
      <div className="overflow-clip relative shrink-0 size-[18px]" data-name="icon-message-go">
        <div className="absolute inset-[16.67%_8.33%_12.5%_12.5%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.25 12.75">
            <path d={svgPaths.pdbb0e80} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
    </button>
...
function Frame31() {
  return (
    <div className="absolute bg-[#303030] content-stretch flex flex-col items-start justify-center left-0 px-[15px] py-[14px] top-0">
      <Frame27 />
      <Frame28 />
      <div className="bg-[#262626] content-stretch flex items-center p-[2px] relative rounded-[15px] shrink-0" data-name="ai-tool-switch-mode">
        <Frame12 />
        <Frame13 />
      </div>
    </div>
...
function Frame14() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[14px] py-[4px] relative rounded-[6px] shrink-0 w-[70px]">
      <p className="font-['Noto_Sans:Medium',sans-serif] font-medium leading-[1.47] relative shrink-0 text-[#484848] text-[15px] text-center tracking-[-0.165px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Finish
      </p>
    </div>
  );
...
function Frame38() {
  return (
    <button className="content-stretch flex flex-col items-center justify-center px-[14px] py-[4px] relative rounded-[6px] shrink-0 w-[155px]">
      <p className="font-['Noto_Sans:Medium',sans-serif] font-medium leading-[1.47] relative shrink-0 text-[#8149ec] text-[15px] text-center tracking-[-0.165px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Advanced options
      </p>
    </button>
  );
...
function Frame37() {
  return (
    <div className="content-stretch cursor-pointer flex gap-[10px] items-start relative shrink-0 w-[258px]">
      <Frame38 />
      <button className="bg-[#8149ec] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="ai-tool-generate-button">
        <div className="flex flex-col items-center justify-center size-full">
          <div className="content-stretch flex flex-col items-center justify-center px-[14px] py-[4px] relative w-full">
            <p className="font-['Noto_Sans:Display_Medium',sans-serif] font-medium leading-[1.47] relative shrink-0 text-[#e9e9e9] text-[15px] text-center tracking-[-0.165px] w-full" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
              Generate
            </p>
          </div>
        </div>
...
function Frame29() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[488px]">
      <Frame14 />
      <Frame37 />
    </div>
  );
...
function Frame30() {
  return (
    <div className="bg-[#303030] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[17px] py-[20px] relative w-full">
          <Frame29 />
        </div>
      </div>
    </div>
...
function AiToolBottom() {
  return (
    <div className="-translate-x-1/2 absolute bottom-0 content-stretch flex flex-col items-center left-1/2 w-[522px]" data-name="ai-tool-bottom">
      <div className="h-0 relative shrink-0 w-[492px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 492 1">
            <line id="Line 25" stroke="var(--stroke-0, #898989)" x2="492" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Frame30 />
...
function Frame15() {
  return (
    <div className="content-stretch flex gap-[14px] items-center px-[5px] py-[9px] relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="icon-undo">
        <div className="absolute inset-[16.67%_16.67%_20.83%_16.67%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 15">
            <path d={svgPaths.p22d78f90} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="icon-redo">
        <div className="absolute inset-[16.67%_16.67%_20.83%_16.67%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 15">
            <path d={svgPaths.p3ee5cd80} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame17() {
  return (
    <div className="content-stretch flex gap-[6px] items-center py-[5px] relative shrink-0">
      <div className="relative shrink-0 size-[8px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
          <circle cx="4" cy="4" fill="var(--fill-0, #8149EC)" id="Ellipse 1" r="4" />
        </svg>
      </div>
      <p className="font-['Noto_Sans:Regular',sans-serif] font-normal leading-[1.47] relative shrink-0 text-[#a6a6a6] text-[10px] text-center tracking-[-0.11px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Generating
      </p>
    </div>
  );
...
function Frame16() {
  return (
    <div className="content-stretch flex gap-[7px] items-center py-[3px] relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="icon-restart">
        <div className="absolute inset-[10.42%_16.67%_12.71%_16.67%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 15.375">
            <path d={svgPaths.p2282f180} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="icon-chevron-left">
        <div className="absolute bottom-1/4 left-[33.33%] right-[35.83%] top-1/4" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.4 12">
            <path d={svgPaths.p1cc3a100} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Noto_Sans:Regular',sans-serif] font-normal leading-[1.47] relative shrink-0 text-[#a6a6a6] text-[11px] text-center tracking-[-0.121px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        1/1
      </p>
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="icon-chevron-right">
        <div className="absolute bottom-1/4 left-[33.33%] right-[35.83%] top-1/4" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.4 12">
            <path d={svgPaths.p33166380} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame18() {
  return (
    <div className="content-stretch flex h-[72px] items-center justify-between pb-[42px] relative shrink-0 w-full">
      <Frame17 />
      <Frame16 />
    </div>
  );
...
function Frame20() {
  return (
    <div className="content-stretch flex items-center justify-between pb-[7px] relative shrink-0 w-full">
      <p className="font-['Noto_Sans:SemiBold',sans-serif] font-semibold leading-[1.47] relative shrink-0 text-[16px] text-center text-white tracking-[-0.176px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Tone
      </p>
      <div className="flex items-center justify-center relative shrink-0">
        <div className="-scale-y-100 flex-none">
          <div className="overflow-clip relative size-[18px]" data-name="icon-more-vert">
            <div className="absolute inset-[16.67%_41.67%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 12">
                <path d={svgPaths.p22d38980} fill="var(--fill-0, #898989)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame19() {
  return (
    <div className="content-stretch flex font-['Noto_Sans:Regular',sans-serif] font-normal items-center justify-between leading-[1.47] pb-[2px] relative shrink-0 text-[#e9e9e9] text-[11px] text-center tracking-[-0.121px] w-full whitespace-nowrap">
...
function Frame32() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-end relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="icon-add">
        <div className="absolute inset-[20.83%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33333 9.33333">
            <path d={svgPaths.p3d6a5100} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Noto_Sans:Display_Medium',sans-serif] font-medium leading-[1.47] relative shrink-0 text-[#898989] text-[13px] text-center tracking-[-0.143px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 100, 'wdth' 100" }}>
        Add a custom slider
      </p>
    </div>
  );
...
function Padding() {
  return <div className="bg-[#303030] h-[100px] shrink-0 w-full" data-name="padding" />;
}

function AiToolTab() {
  return (
    <div className="absolute bg-[#303030] h-[887px] left-[28px] overflow-x-clip overflow-y-auto rounded-bl-[5px] rounded-tl-[5px] top-0 w-[522px]" data-name="ai-tool-tab">
      <Frame31 />
      <AiToolBottom />
      <div className="absolute bg-[#303030] content-stretch flex flex-col items-start left-[22px] top-[108px] w-[478px]" data-name="ai-tool-rewrite-sliders">
        <Frame15 />
        <div className="bg-white content-stretch flex flex-col items-center justify-center min-h-[280px] overflow-clip p-[10px] relative rounded-[4px] shrink-0 w-[478px]" data-name="ai-tool-text-area">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[1.47] relative shrink-0 text-[16px] text-[rgba(0,0,0,0.33)] tracking-[-0.176px] w-[414px]">Select some text</p>
        </div>
        <Frame18 />
        <div className="content-stretch flex flex-col items-start pb-[46px] relative shrink-0 w-full">
          <Frame20 />
          <Frame19 />
          <div className="h-[15px] relative shrink-0 w-full" data-name="Component 2">
            <div className="absolute flex inset-[20%_0_26.67%_0] items-center justify-center">
              <div className="-scale-y-100 flex-none h-[8px] w-[478px]">
                <div className="bg-[#484848] rounded-[5.5px] size-full" />
              </div>
            </div>
            <div className="absolute flex inset-[20%_49.58%_26.67%_0] items-center justify-center">
              <div className="-scale-y-100 flex-none h-[8px] w-[241px]">
                <div className="bg-[#e9e9e9] rounded-[5.5px] size-full" />
              </div>
            </div>
            <button className="-translate-y-1/2 absolute aspect-[15/15] block cursor-pointer left-[48.54%] right-[48.33%] top-[calc(50%-1px)]">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
                <circle cx="7.5" cy="7.5" fill="var(--fill-0, #E9E9E9)" id="Ellipse 2" r="7.5" />
              </svg>
            </button>
          </div>
        </div>
...
function AiToolTabClose() {
  return (
    <div className="absolute bg-[#303030] content-stretch flex items-center left-0 overflow-clip pl-[10px] pr-[15px] py-[8px] rounded-bl-[15px] rounded-tl-[15px] top-0 w-[41px]" data-name="ai-tool-tab-close">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="icon-chevron-right">
        <div className="absolute bottom-1/4 left-[33.33%] right-[35.83%] top-1/4" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.16667 10">
            <path d={svgPaths.pd581500} fill="var(--fill-0, #E9E9E9)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Left() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="left">
      <UndoRedo />
      <div className="flex h-[17px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "21" } as React.CSSProperties}>
...
export default function Component() {
  return (
    <div className="bg-[#212121] relative size-full" data-name="2">
      <div className="absolute h-[887px] left-[890px] top-[135px] w-[550px]" data-name="ai-tool-tab">
        <AiToolTab />
        <AiToolTabClose />
      </div>
      ...
      <div className="absolute content-stretch flex flex-col items-start left-[36px] top-[229px] w-[846px]" data-name="Document">
        <Letter />
        <Padding1 />
      </div>
    </div>
