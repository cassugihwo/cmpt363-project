import svgPaths from "./svg-voprssz6u1";
      ...
      <div className="overflow-clip relative shrink-0 size-[18px]" data-name="icon-tune-sliders">
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5 13.5">
            <path d={svgPaths.p1c434f60} fill="var(--fill-0, #898989)" id="Vector" />
          </svg>
        </div>
      </div>
    </button>
      ...
      <div className="overflow-clip relative shrink-0 size-[18px]" data-name="icon-message-go">
        <div className="absolute inset-[16.67%_8.33%_12.5%_12.5%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.25 12.75">
            <path d={svgPaths.pdbb0e80} fill="var(--fill-0, #E9E9E9)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame27() {
  return (
    <div className="h-[20px] relative shrink-0 w-[492px]">
      <div className="absolute inset-[-5%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 492 21">
          <g id="Frame 59">
...
function Add() {
  return (
    <div className="bg-white content-stretch flex items-start p-[4px] relative rounded-[25px] shrink-0 w-[24px]" data-name="add">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="icon-add">
        <div className="absolute inset-[20.83%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33333 9.33333">
            <path d={svgPaths.p3d6a5100} fill="var(--fill-0, #A6A6A6)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame21() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[488px]">
      <Frame14 />
      <button className="bg-[#8149ec] content-stretch cursor-pointer flex flex-col items-center justify-center px-[14px] py-[4px] relative rounded-[6px] shrink-0 w-[90px]" data-name="ai-tool-generate-button">
...
function Frame22() {
  return (
    <div className="bg-[#303030] h-[70px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[17px] py-[20px] relative size-full">
          <Frame21 />
        </div>
      </div>
    </div>
...
function AiToolBottom1() {
  return (
    <div className="bg-[#303030] content-stretch flex flex-col items-center relative shrink-0 w-[522px]" data-name="ai-tool-bottom">
      <Frame27 />
      <div className="bg-[#3a3a3a] content-stretch flex items-center justify-between overflow-clip px-[12px] py-[9px] relative rounded-[10px] shrink-0 w-[492px]">
        <button className="block cursor-pointer font-['Noto_Sans:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#898989] text-[10px] text-left tracking-[-0.11px] w-[400px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
          <p className="leading-[1.47]">How do you want to rewrite this?</p>
        </button>
        <Add />
      </div>
      <Frame22 />
...
function Frame25() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="icon-delete">
        <div className="absolute inset-[12.5%_16.67%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33333 10.5">
            <path d={svgPaths.p12018c80} fill="var(--fill-0, #F53B3B)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="icon-edit">
        <div className="absolute inset-[12.5%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 10.5">
            <path d={svgPaths.p323340} fill="var(--fill-0, #E9E9E9)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame24() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="font-['Noto_Sans:SemiBold',sans-serif] font-semibold leading-[1.47] relative shrink-0 text-[#e9e9e9] text-[10px] tracking-[-0.11px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Prompt 1
      </p>
      <Frame25 />
    </div>
...
function PromptBubble() {
  return (
    <div className="bg-[#3a3a3a] relative rounded-[10px] shrink-0 w-full" data-name="prompt bubble">
      <div className="content-stretch flex flex-col gap-[10px] items-start px-[12px] py-[14px] relative w-full">
        <Frame24 />
        <p className="font-['Noto_Sans:Medium',sans-serif] font-medium leading-[1.47] relative shrink-0 text-[#e9e9e9] text-[13px] tracking-[-0.143px] w-[452px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>{`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nunc arcu, laoreet ut ornare ut, condimentum scelerisque nisl. `}</p>
      </div>
    </div>
  );
}
...
function Padding() {
  return <div className="bg-[#303030] h-[150px] shrink-0 w-full" data-name="padding" />;
}

function AiToolTab() {
  return (
    <div className="absolute bg-[#303030] h-[887px] left-[28px] overflow-x-auto overflow-y-clip rounded-bl-[5px] rounded-tl-[5px] top-0 w-[522px]" data-name="ai-tool-tab">
      <Frame23 />
      <AiToolBottom />
      <div className="absolute bg-[#303030] content-stretch flex flex-col items-start left-[22px] top-[108px] w-[478px]" data-name="ai-tool-rewrite-sliders">
        ...
        <Frame18 />
        <div className="content-stretch flex flex-col items-start pb-[25px] relative shrink-0 w-full" data-name="prompt bubble">
          <PromptBubble />
        </div>
        <div className="content-stretch flex flex-col items-start pb-[25px] relative shrink-0 w-full" data-name="prompt bubble">
          <PromptBubble1 />
...
export default function Component() {
  return (
    <div className="bg-[#212121] relative size-full" data-name="3">
